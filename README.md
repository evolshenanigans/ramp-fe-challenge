...
**SOLUTION:** index css. on line 93 we changed .RampInputSelect--dropdown-container's positon to absolute. This way it will be relative to the viewport and not the parent element.
...
**Solution:** in index.css we changed .RampInputCheckbox--input's opacity to 0, and added a cursor pointer. This way the checkbox is clickable and the user can see that it is clickable. 
...
**solution**  in app.tsx i changed line 68-72 to handle choosing all employees.
...
**solution** in hooks/usepagination i changed line 24.
...
**solution** fix in app.tsx line 82
...
**solution** find in app.tsx line 82
...
**solution** components/transaction.tsx line 16
